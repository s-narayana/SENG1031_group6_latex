...
\Feature{Filter repositories based on a number of parameters.}\\[0.2cm]
...
% Feature
\noindent \Feature{Code in repository opens a hyperlink to the complete wiki documentation.}\\[0.2cm]
...
\noindent\Feature{A small tool tip summary of that data type is shown (showing its methods and attributes.)}\\[0.2cm]
...
\Feature{ Holistic view of functions of code.}\\[0.2cm]
...
\Feature{Searching for users based on how active they are.}\\[0.2cm]
...
\Feature{Searching for users based on what kind of projects they contribute to.}\\[0.2cm]
